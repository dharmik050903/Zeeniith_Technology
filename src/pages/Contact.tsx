...
const Contact = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Note: The recipient email (info@zeeniith.in) must be configured 
      ...
      const errorMessage = error instanceof Error
        ? error.message
        : 'Sorry, there was an error sending your message. Please try again or contact us directly at info@zeeniith.in'
